...
During this project, I gained experience creating and using predefined macros 
in C programming. Additionally, I had the opportunity to practice writing my 
own macros and incorporating header file include guards.
