...
In this project, we covered an important concepts in C programming: variadic functions.
Variadic functions allow us to write functions that can take a variable number of arguments.
To perform variadic functions operations we use the `va_list`, `va_start`, `va_arg`, and `va_end` macros.
