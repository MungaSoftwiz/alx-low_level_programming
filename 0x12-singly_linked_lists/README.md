...
This directory contains tasks on singly linked lists in C while learning
when and why to use `linked lists` versus `arrays`.These tasks are designed
to test our understanding of singly linked lists and help us practice
implementing them in various scenarios.
